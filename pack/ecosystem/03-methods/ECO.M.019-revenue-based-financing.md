...
| Force | Tension |
|-------|---------|
| Скорость привлечения (RBF, недели, §3 «Быстрый процесс») ↔ совокупная стоимость капитала | RBF закрывается быстрее VC, но обходится дороже в абсолюте (1.3-2× возврат, §3 «Ограничения») — быстрый капитал не значит дешёвый |
| Сохранение контроля (§2 таблица: «Нет dilution», «Полный» контроль) ↔ доступность только при предсказуемой выручке | RBF/Grants не размывают долю, но RBF требует MRR (§3 «Нужна выручка») — pre-revenue стартапы этот инструмент использовать не могут |
| Гибкость платежей, масштабируются с выручкой (§3 «Преимущества») ↔ cash flow pressure | Ежемесячные платежи RBF снижают runway именно тогда, когда выручка есть, но ещё нестабильна (§3 «Ограничения») |
...
|------|--------------------------|
| «Нет dilution» переоценивается относительно совокупной стоимости капитала | Внимание фиксируется на видимом преимуществе RBF/Grants — сохранённой доле (§2 таблица) — и недооценивает менее заметную, но реальную стоимость (1.3-2× возврат, §3 «Ограничения») |
| Размер грантового пула затмевает fit программе | При чтении §5 внимание уходит к крупной цифре («US DoE — до $167M») вместо соответствия фокусу программы (колонка «Фокус») — низкая вероятность fit теряется за впечатляющим числом |
| Стадия — единственный критерий выбора в Decision Framework | В §6 внимание смещается к «на какой я стадии» и недооценивает фактор Impact (последняя строка) — Grants как опция выпадает из рассмотрения, если фаундер не думает о себе как об impact-проекте |
