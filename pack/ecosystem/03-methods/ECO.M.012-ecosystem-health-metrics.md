...
| Force | Tension |
|-------|---------|
| Охват системы ↔ измеримость | Health хочет измерить всю систему взаимодействий (peer-to-peer, contribution), но чем шире охват, тем труднее найти измеримый прокси — внимание соскальзывает на то, что считается (product metrics) |
| Композитный балл ↔ диагностичность | Единый Health Score (0–100) удобен стейкхолдерам, но усреднение прячет, какое из 4 измерений проседает; раздельные метрики диагностичны, но не дают одной цифры |
| Раннее предупреждение ↔ ложные тревоги | Чувствительные пороги красных флагов ловят «умирание» заранее, но дают ложные срабатывания на сезонность; тупые пороги опаздывают |
...
|------|--------------------------|
| Countable-видимое важнее значимого | Внимание съезжает на метрики, которые легко посчитать и показать (followers, likes, DAU), и прочь от трудноизмеримой peer-to-peer ценности: дашборд заполняется измеримым, а не важным — корень FM.EH.001 |
| Смещение к среднему | При чтении дашборда внимание идёт к агрегатам (общий retention, средний growth), прячущим когортное ухудшение: «кто именно уходит» выпадает, остаётся «в среднем нормально» — корень FM.EH.003 |
| Смещение к активному меньшинству | Внимание естественно идёт к видимой активной части (creators, постящие): «шумная» экосистема читается как здоровая, молчаливое большинство выпадает из поля зрения |
