...
| Force | Tension |
|-------|---------|
| Скорость реакции ↔ основательность решения | Три уровня (§2) работают на разных горизонтах — L1 (дни-недели) и L3 (месяцы-кварталы); сигнал, требующий быстрой реакции на одном уровне, может преждевременно давить на решения другого |
| Quantitative-скорость ↔ qualitative-глубина | §3 «Каналы сбора»: bot 👍/👎 (секунды) отвечает на «что», user interview (неделя) — на «почему»; тяга к быстрому каналу оставляет вопрос «почему» без ответа (см. FM.FL.003/004) |
| Еженедельный ритм discovery ↔ репрезентативность выборки | Teresa Torres требует минимум 1 интервью в неделю (§3), но ограниченная еженедельная выборка рискует быть захвачена «громким голосом» вместо среднего пользователя (§7 «Loudest voice wins») |
...
|------|--------------------------|
| Countable-канал важнее значимого | Внимание съезжает к легко агрегируемому количественному сигналу (bot 👍/👎, NPS, §3) и уходит от трудоёмкого качественного (интервью) — дашборд заполняется быстрым, а не объясняющим |
| Громкий/недавний голос вместо систематического ритма | Внимание смещается к последнему заметному посту в Discourse или самому активному жалующемуся, уходя от планового weekly review (§7 «Feedback graveyard», «Loudest voice wins») |
| Факт сбора переоценивается, замыкание цикла недооценивается | Практик успокаивается на этапе «мы собрали feedback» (§3 каналы), а этап «Вы просили → мы сделали» (§3 Closing the loop) откладывается или пропускается |
